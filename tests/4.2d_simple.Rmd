...
cat("Sum of all predictions on response scale:", sum(preds_out), "this should be 2156.822. \n\n")

cat("Sum of all predictions on link scale:", sum(preds_out_link), "this should be -4961.709. \n\n")
...
cat("Mean square error:", mean_sum_sq, "this should be 0.8052403. \n\n")

mean_sum_sq_data <- sum((data$response - predict.gamMRSea(newdata=data, object=salsa2dOutput$bestModel))^2)/nrow(data)

cat("residual sum square error to data:", mean_sum_sq_data, "this should be 11.86261. \n\n")
...
cat("Mean square error to truth unseen:", mean_sum_sq_unseen, "this should be 0.7833794. \n\n")
