...
cat("Sum of all predictions on response scale:", sum(preds_out), "this should be 2203.845. \n\n")

cat("Sum of all predictions on link scale:", sum(preds_out_link), "this should be -8350.405. \n\n")

cat("Time for training:", round(total_time, 1), "Original time: 13.4. \n\n")
...
cat("Number of model fits:", n_fits, "Original model fits: 408")
...
cat("Sum of all estimates:", sum(sum_results$coefficients[,1]), "this should be 6.178555. \n\n")

cat("Sum of all robust SE:", sum(sum_results$coefficients[,3]), "this should be 23.6371. \n\n")
...
cat("Dispersion:", sum_results$dispersion, "this should be 23.69341. \n\n")
...
cat("Mean square error:", mean_sum_sq, "this should be 0.4287839. \n\n")

mean_sum_sq_data <- sum((data$response - predict.gamMRSea(newdata=data, object=salsa2dOutput$bestModel))^2)/nrow(data)

cat("residual sum square error to data:", mean_sum_sq_data, "this should be 5.911513. \n\n")
...
cat("Mean square error to truth seen:", mean_sum_sq_seen, "this should be 0.4704165. \n\n")

mean_sum_sq_unseen <- sum((predictData$truth.re[!rows_seen] - preds_out[!rows_seen])^2)/nrow(predictData[!rows_seen,])

cat("Mean square error to truth unseen:", mean_sum_sq_unseen, "this should be 0.41539. \n\n")
